...
{
public:
	SkyboxEffect(ID3D11Device* device, ID3D11DeviceContext* context, UINT screenWidth, UINT screenHeight);

	virtual void Render(ID3D11DeviceContext* context, VertexBuffers::VertexBuffer_P* vertex_buffer);
